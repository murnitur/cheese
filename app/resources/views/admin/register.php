...
<div class="row mt-4 mb-4">
  <div class="col-md-6 mx-auto">
    ...
    <p class="text-center">Fill in all details</p>
    <form action="<?php echo URLROOT;?>/admin/register" method="post">
      <div class="form-group">
        <label>Username</label>
        <input type="text" name="username" placeholder="Username" class="form-control <?php echo !empty($data['user_err']) ? "is-invalid" : ""; ?>" value="<?php echo $data['username'];?>">
      ...
      <div class="form-group">
        ...
        <input type="password" name="confirm_password" placeholder="Retype Password" class="form-control <?php echo !empty($data['r_pwd_err']) ? "is-invalid" : ""; ?>" value="<?php echo $data['r_pwd'];?>">
        <span class="invalid-feedback"><?php echo $data['r_pwd_err'];?></span>
      </div>
      <div class="form-group">
